...
var _menus=[
    {"menuid":"00","icon":"fa-trophy","menuname":"车辆管理",parentMenu:'0',
     ...
     "menuid":"01","icon":"fa-television","menuname":"从业人员",parentMenu:'1',
        "menus":[{"menuid":"010","menuname":"新报名人员","icon":"fa-tty","url":"https://iaobao.com/item.htm?id=545823027227"},
                ...
                {"menuid":"120","menuname":"未通过考试人员","icon":"fa-globe","url":"https://iaobao.com/item.htm?id=545823027227"},
                ...
                {"menuid":"120","menuname":"发证机关","icon":"fa-globe","url":"https://iaobao.com/item.htm?id=545823027227"},
	...
	{"menuid":"21","icon":"fa-plug","menuname":"处罚文书",parentMenu:'2',
		"menus":[
            {"menuid":"210","menuname":"案件登记","icon":"fa-toggle-down","url":"zfws/xywzAddPage"},
//            {"menuid":"211","menuname":"网约无证案件","icon":"fa-puzzle-piece","url":"demo/msgTip1.html"},
//            {"menuid":"212","menuname":"议价有证案件","icon":"fa-desktop","url":"demo/msgTip1.html"},
//            {"menuid":"213","menuname":"车容车貌有证案件","icon":"fa-window-restore","url":"demo/msgTip1.html"},
//            {"menuid":"214","menuname":"通用案件","icon":"fa-calendar","url":"demo/msgTip1.html"},
            {"menuid":"215","menuname":"查询案件","icon":"fa-chevron-circle-down","url":"zfws/ajListPage"}
		]
	},
	{"menuid":"22","icon":"fa-cubes","menuname":"信息管理",parentMenu:'2',
		"menus":[{"menuid":"220","menuname":"案由信息管理","icon":"fa-dot-circle-o","url":"demo/inonSvg.html"},
			{"menuid":"221","menuname":"处罚金额管理","icon":"fa-sticky-note","url":"demo/msgTip1.html"},
            {"menuid":"222","menuname":"基本信息管理","icon":"fa-window-minimize","url":"zfxx/jbxxPage"},
            {"menuid":"223","menuname":"执法人员管理","icon":"fa-sort-numeric-asc","url":"zfxx/zfryListPage"},
            {"menuid":"224","menuname":"执法依据信息管理","icon":"fa-bookmark","url":"zfxx/zfyjListPage"}
		]
	},
    {"menuid":"31","icon":"fa-suitcase","menuname":"车辆统计报表",parentMenu:'3',
    	"menus":[{"menuid":"311","menuname":"车辆基本情况","icon":"fa-inbox","url":"demo/msgTip1.html"},
    			{"menuid":"312","menuname":"各公司分布情况","icon":"fa-share-alt-square","url":"demo/msgTip1.html"},
    			{"menuid":"312","menuname":"车辆分布情况","icon":"fa-share-alt-square","url":"demo/msgTip1.html"},
    			{"menuid":"312","menuname":"路线分布情况","icon":"fa-share-alt-square","url":"demo/msgTip1.html"},
    			{"menuid":"312","menuname":"车型公司统计","icon":"fa-share-alt-square","url":"demo/msgTip1.html"}
    		]
    	},
