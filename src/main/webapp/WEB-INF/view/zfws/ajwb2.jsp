		...
		<form id="form" method="post" style="padding-left: 15px">
			...
			<div class="itemForm" style="width: 100%">
				...
				<a href="javascript:void(0);" class="easyui-linkbutton"
						data-options="iconCls:'icon-save',plain:true" onclick="toAjwbPage();">处理与送达</a>
			</div>
		</form>
	</div>
	<div data-options="region:'east'" style="width: 430px;">
		<div id="tt" class="easyui-tabs" data-options="fit:true">
			<div title="讨论人员" style="height: 100%;">
			...
			<div title="问答表">tab2</div>
			<div title="送达文书"">tab3</div>
			<div title="证件材料表">tab3</div>
			<div title="证件列表">tab3</div>
		</div>
	</div>
</body>
</html>
