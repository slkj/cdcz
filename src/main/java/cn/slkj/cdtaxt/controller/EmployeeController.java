...
import cn.slkj.cdtaxt.service.EmployeeService;
import cn.slkj.slUtil.Const;
import cn.slkj.slUtil.Logger;
...
//			List<PageData> rank = this.employeeService.getEmployeeRank(pd.getString("ID"));
//			List<PageData> continueRegister = this.employeeService.getEmployeeContinueRegister(pd.getString("ID"));
